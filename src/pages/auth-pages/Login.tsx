...
const Login = ({ type }: Props) => {
  ...
  return (
    <div className='p-2'>
      ...
      <input className='border border-black mt-2 block px-2' type="text" placeholder="Username" value={username} onChange={e => setUsername(e.target.value)} />
      <input className='border border-black mt-2 block px-2' type="password" placeholder="Password" value={password} onChange={e => setPassword(e.target.value)} />
